    ...
    <>
      <div className="flex gap-2">
        <input value={photoLink}
               ...
               type="hidden"  placeholder={'Add using a link ....jpg'}/>
        <button  onClick={addPhotoByLink} className="bg-gray-200 px-4 rounded-2xl hidden">Add&nbsp;photo</button>
      </div>
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        {addedPhotos.length > 0 && addedPhotos.map(link => (
          <div className="h-32 flex relative" key={link}>
            <img className="rounded-2xl w-full object-cover" src={'https://vacationhub-api.onrender.com/uploads/'+link} alt=" img"/>
